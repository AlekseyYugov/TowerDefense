...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        public static void RandomVector(ref Vector3 start, ref Vector3 end, float offsetAmount, out Vector3 result)
        {
            if (orthographic)
            {
        ...
        {
            Vector3 start, end;
            EndObject = FindObjectOfType<Enemy>().gameObject; //hit.collider.transform.root.GetComponent<Enemy>();
